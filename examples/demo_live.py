...
def main() -> None:
    ...
    print()
    print("Next steps:")
    print("  - LangGraph integration: python -m lars.langgraph_integration")
    print("  - Full benchmark:        python examples/run_benchmark.py")
    print("  - Test suite:            python tests/test_merge.py")
    print()
